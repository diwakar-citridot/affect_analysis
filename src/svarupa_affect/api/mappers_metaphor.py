...
from ..application.mappers import _aggregate_attribute_scores, _signal_to_dto
from ..domain.models import LayerContext, Provenance
...
def to_metaphor_response(
    ...
    prov = result.signals[0].provenance if result.signals else Provenance(layer_version="")
